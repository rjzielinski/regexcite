...
second [rex](https://cran.r-project.org/package=rex), and
...
devtools::install_github("rjzielinski/regexcite")
```
...
output is inconvenient, i.e. we want the unlisted version.
