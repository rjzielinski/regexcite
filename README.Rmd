...
**NOTE: This is a toy package created for expository purposes, for the second [rex](https://cran.r-project.org/package=rex), and [rematch2](https://cran.r-project.org/package=rematch2).**
...
Often the shape of this output is inconvenient, i.e. we want the unlisted version.
